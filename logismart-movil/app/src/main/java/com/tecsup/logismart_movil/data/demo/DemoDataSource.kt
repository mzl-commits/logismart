...
object DemoDataSource {
    ...
    private val boxes = mutableListOf(
        LogisticBox("CAJ-20260630-001", "Sensores industriales", 6, "8.50", "Electrónica", "pendiente", "Sin ubicación", "Sin asignar", true),
        LogisticBox("CAJ-20260630-002", "Herramientas de precisión", 4, "14.20", "Herramienta", "en_transito", "A1-N2-P1", "AGV principal", false),
        LogisticBox("CAJ-20260630-003", "Uniformes operativos", 20, "11.00", "Textil", "almacenada", "B1-N1-P2", "Sin asignar", false),
        LogisticBox("CAJ-20260630-004", "Reactivos sellados", 2, "5.40", "Químico", "almacenada", "Q1-N1-P1", "Sin asignar", true),
    )
    ...
    fun updateBox(id: String, state: String): Boolean {
        ...
        boxes[index] = current.copy(
            ...
            carroAsignado = if (state == "en_transito") "AGV principal" else "Sin asignar",
        )
        return true
    }
    ...
    fun trips(): List<Trip> = listOf(
        Trip(104, "2026-06-30", "Almacén principal", "Centro de distribución Lima", "Completado", "Base AGV → Pasillo A → Despacho", "14 min", "CAJ-20260629-008", "AGV-01"),
        Trip(103, "2026-06-29", "Almacén principal", "Sucursal San Isidro", "Completado", "Base AGV → Pasillo B → Despacho", "18 min", "CAJ-20260629-004", "AGV-01"),
        Trip(102, "2026-06-28", "Almacén principal", "Tienda Miraflores", "Completado", "Base AGV → Zona química → Despacho", "12 min", "CAJ-20260628-011", "AGV-02"),
    )
    ...
    fun vehicles() = listOf(VehiculoDto("ABC-123", "Toyota"), VehiculoDto("LOG-001", "AGV LogiSmart"))
